...
## Overview
Journeys helps you retrieve your end user's search and social journeys (collections of user interactions - read more here[ADD LINK] from Fabric's supported integrations on an ongoing basis. 

...
You can create an additional Fabric Link consent with a different data provider (e.g. LinkedIn) by navigating to the consents tab and clicking on Create Consent. 
